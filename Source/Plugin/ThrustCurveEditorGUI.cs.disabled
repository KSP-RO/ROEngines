...
namespace ROEngines
{
    public class ThrustCurveEditorGUI : MonoBehaviour
    {
        ...
        private static int graphHeight = 480;
        private static int scrollHeight = 200;
        ...
        private static ROEEngineThrustCurveGUI module;
        ...
        {
            windowRect = GUI.Window(id, windowRect, updateGraphWindow, "SRB Thrust Curve Chooser");
            /*
            if (presetWindowOpen)
            {
