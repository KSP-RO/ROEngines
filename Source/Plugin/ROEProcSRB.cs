...
namespace ROEngines
{
    public class ROEProcSRB : PartModule, IPartCostModifier, IPartMassModifier, IRecolorable
    {
        ...
        /// </summary>
        [KSPField]
        public string baseTransformName = "ROE-ProcSRB-BaseTransform";
        ...
        /// </summary>
        [KSPField]
        public String thrustTransformName = "ROE-ProcSRB-ThrustTransform";

        [KSPField]
        public String gimbalTransformName = "ROE-ProcSRB-GimbalTransform";
        ...
        /// </summary>
        [KSPField]
        public String rcsThrustTransformName = "rcsTransform";
        ...
        [KSPField]
        public float maxDiameter = 6.6f;

        [KSPField]
        public float diameterIncrement = 0.1f;
        ...
        [KSPField(guiName = "Burn Time", guiActiveEditor = true)]
        ...
        private ModelModule<SingleModelData, ROEProcSRB> noseModule;
        private ModelModule<SRBModelData, ROEProcSRB> bodyModule;
        private ModelModule<SRBNozzleData, ROEProcSRB> mountModule;
        ...
        public TextureSet getSectionTexture(string section)
        {
            ...
            {
                return bodyModule.currentTextureSet;
            }
            else if (section == "Bottom")
            {
        ...
        private void loadConfigNodeData()
        {
            ...
            bodyModule.getValidSelections = m => bodyModule.models.FindAll(s => s.variant == currentVariantName && s.isAvailable(this.upgradesApplied));
            bodyModule.getDisplayNames = m => SSTUUtils.getNames(m, s => s.length);
